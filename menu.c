...
/* Disabling some options for in-emulator editing until the file browser crash bug is fixed: */

	dialog_text("Mono Palette",palname,0);
	...
	dialog_text("DMG Border Image",bordername,0);
	//dialog_text("DMG Border Image",bordername,FIELD_SELECTABLE);        /* 6 */
	dialog_text("GBC Border Image",gbcbordername,0);
	...
	switch(ret=dialog_end(0)){
		...
		case 14: /* Apply & Save */
			...
			sprintf(config[6],"set button_r %i",btnr);
			    ...
			    if (btna == 1) {sprintf(config[7],"bind alt +a");}
			    if (btnb == 1) {sprintf(config[8],"bind ctrl +a");}
			    if (btnx == 1) {sprintf(config[9],"bind shift +a");}
			    if (btny == 1) {sprintf(config[10],"bind space +a");}
			    if (btnl == 1) {sprintf(config[11],"bind tab +a");}
			    if (btnr == 1) {sprintf(config[12],"bind backspace +a");}

			    if (btna == 2) {sprintf(config[7],"bind alt +b");}
			    if (btnb == 2) {sprintf(config[8],"bind ctrl +b");}
			    if (btnx == 2) {sprintf(config[9],"bind shift +b");}
			    if (btny == 2) {sprintf(config[10],"bind space +b");}
			    if (btnl == 2) {sprintf(config[11],"bind tab +b");}
			    if (btnr == 2) {sprintf(config[12],"bind backspace +b");}

			    if (btna == 3) {sprintf(config[7],"bind alt +select");}
			    if (btnb == 3) {sprintf(config[8],"bind ctrl +select");}
			    if (btnx == 3) {sprintf(config[9],"bind shift +select");}
			    if (btny == 3) {sprintf(config[10],"bind space +select");}
			    if (btnl == 3) {sprintf(config[11],"bind tab +select");}
			    if (btnr == 3) {sprintf(config[12],"bind backspace +select");}

			    if (btna == 4) {sprintf(config[7],"bind alt +start");}
			    if (btnb == 4) {sprintf(config[8],"bind ctrl +start");}
			    if (btnx == 4) {sprintf(config[9],"bind shift +start");}
			    if (btny == 4) {sprintf(config[10],"bind space +start");}
			    if (btnl == 4) {sprintf(config[11],"bind tab +start");}
			    if (btnr == 4) {sprintf(config[12],"bind backspace +start");}

			    if (btna == 5) {sprintf(config[7],"bind alt reset");}
			    if (btnb == 5) {sprintf(config[8],"bind ctrl reset");}
			    if (btnx == 5) {sprintf(config[9],"bind shift reset");}
			    if (btny == 5) {sprintf(config[10],"bind space reset");}
			    if (btnl == 5) {sprintf(config[11],"bind tab reset");}
			    if (btnr == 5) {sprintf(config[12],"bind backspace reset");}

			    if (btna == 6) {sprintf(config[7],"bind alt quit");}
			    if (btnb == 6) {sprintf(config[8],"bind ctrl quit");}
			    if (btnx == 6) {sprintf(config[9],"bind shift quit");}
			    if (btny == 6) {sprintf(config[10],"bind space quit");}
			    if (btnl == 6) {sprintf(config[11],"bind tab quit");}
			    if (btnr == 6) {sprintf(config[12],"bind backspace quit");}
				
				if (btna == 7) {sprintf(config[7],"bind alt savestate");}
			    if (btnb == 7) {sprintf(config[8],"bind ctrl savestate");}
			    if (btnx == 7) {sprintf(config[9],"bind shift savestate");}
			    if (btny == 7) {sprintf(config[10],"bind space savestate");}
			    if (btnl == 7) {sprintf(config[11],"bind tab savestate");}
			    if (btnr == 7) {sprintf(config[12],"bind backspace savestate");}
				
				if (btna == 8) {sprintf(config[7],"bind alt loadstate");}
			    if (btnb == 8) {sprintf(config[8],"bind ctrl loadstate");}
			    if (btnx == 8) {sprintf(config[9],"bind shift loadstate");}
			    if (btny == 8) {sprintf(config[10],"bind space loadstate");}
			    if (btnl == 8) {sprintf(config[11],"bind tab loadstate");}
			    if (btnr == 8) {sprintf(config[12],"bind backspace loadstate");}
...
int menu(){
	...
	while(!mexit){
		...
		dialog_text("Exit","",FIELD_SELECTABLE);                 /* 11 */
...
launcher:
	...
	dialog_text("Exit","",FIELD_SELECTABLE);                 /* 6 */
